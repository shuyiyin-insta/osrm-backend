...
class IsochroneParameters(BaseParameters):
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(
        self,
        contours_seconds: Sequence[float] = [],
    ...
    @property
    def contours_seconds(self) -> list[float]: ...
    @contours_seconds.setter
    def contours_seconds(self, arg: Sequence[float], /) -> None: ...
    @property
    def direction(self) -> IsochroneDirection: ...
    @direction.setter
    def direction(self, arg: IsochroneDirection, /) -> None: ...
    @property
    def polygons(self) -> bool: ...
    @polygons.setter
    def polygons(self, arg: bool, /) -> None: ...
    @property
    def generalize(self) -> float | None: ...
    @generalize.setter
    def generalize(self, arg: float | None, /) -> None: ...
    @property
    def denoise(self) -> float | None: ...
    @denoise.setter
    def denoise(self, arg: float | None, /) -> None: ...
    def IsValid(self) -> bool: ...

class IsochroneDirection:
    def __init__(self, arg: str, /) -> None: ...
    def __repr__(self) -> str: ...
...
class OSRM:
    ...
    @overload
    def __init__(self, **kwargs) -> None: ...
    def Isochrone(self, arg: IsochroneParameters, /) -> Object:
        """
        Computes the region reachable from one coordinate within each supplied elapsed-duration contour in seconds. Durations are evaluated at decisecond precision.
